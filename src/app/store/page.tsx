    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-2 text-4xl font-black tracking-tight">
          Team gear and fan merchandise
        </h1>
        <p className="mt-3 text-slate-600">
          Start with lightweight merch listings and later connect Shopify or
          ...
          >
            ...
            {product.buy_url ? (
              <Link
                ...
                className="mt-4 inline-flex rounded-2xl bg-slate-900 px-4 py-2 font-semibold text-white"
              >
                Buy Now
              </Link>
            ) : (
              <button
                className="mt-4 rounded-2xl bg-slate-900 px-4 py-2 font-semibold text-white"
                type="button"
              >
                Buy Now
              </button>
