    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-2 text-4xl font-black tracking-tight">
          Clinics, prospect skates, alumni events, and fundraisers
        </h1>
      </div>
        ...
        {events.map((event) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="mt-4 line-clamp-3 text-slate-600">
                {event.description}
              </div>

              <Link
                href={`/events/${event.slug}`}
                className="mt-5 inline-flex rounded-2xl bg-slate-900 px-4 py-2 font-semibold text-white"
              >
                View Event
              </Link>
            </div>
